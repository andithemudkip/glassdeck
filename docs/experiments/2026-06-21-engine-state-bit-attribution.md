...
- [ ] No changes needed to [[post-kill-decay-groups]] or [[byte-d7-checksum-hypothesis]] — the decay timing observed here corroborates the existing Fast-group envelope rather than refining it, and D7 was out of scope for this experiment.
